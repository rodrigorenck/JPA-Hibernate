...
public class BuscaDinamica {
    ...
    public static void main(String[] args) {
        ...
        List<Produto> produtos = produtoDao.buscaPorParametrosOpcionais(null, null, null);
        produtos.forEach(p -> System.out.println(p.getNome()));

        System.out.println();

        //tem que mostrar todos produtos com nome Almofadas
        List<Produto> produtos2 = produtoDao.buscaPorParametrosOpcionais("Almofadas", null, null);
        produtos2.forEach(p -> System.out.println(p.getNome()));

        System.out.println();

        //tem que mostrar apenas a Almofada de preco 100 reais
        List<Produto> produtos3 = produtoDao.buscaPorParametrosOpcionais("Almofadas", new BigDecimal("100"), null);
        produtos3.forEach(p -> System.out.println(p.getNome()));

        System.out.println();

        //tem que mostrar todos os produtos de preco 100 reais
        List<Produto> produtos4 = produtoDao.buscaPorParametrosOpcionais(null, new BigDecimal("100"), null);
        produtos4.forEach(p -> System.out.println(p.getNome()));
